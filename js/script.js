	...
	$( function ()
	{
		...
		function initOwlCarousel ( carousel )
		{
			...
			carousel.owlCarousel( {
				...
				navText: carousel.attr('data-nav-text') ? JSON.parse(carousel.attr('data-nav-text')) : [],
				navClass: carousel.attr('data-nav-class') ? JSON.parse(carousel.attr('data-nav-class')) : ['owl-prev', 'owl-next']
